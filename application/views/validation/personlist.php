...
<html lang="zh-cn">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <h3 class="text-center"><?=$validationname?>鉴定情况详细信息维护</h3>
      </div>
      <hr/>
    <div>
    ...
    <div class="row col-sm-offset-2" id="upload" >
        <form role="form" class="form-horizontal" action="<?=site_url('validationmanage/pe_arrange')?>" method="post">
	        <div hidden>
	           <input type="text" class="form-control" name="number" value="<?=$number?>">
	        </div>
	      	<?php foreach($validationlist as $item):?>
    ...
    <div class="row col-sm-offset-2" id="upload" >
        <form role="form" class="form" action="<?=site_url('validationmanage/pe_add')?>" method="post">
	        <div hidden>
	           <input type="text" class="form-control" name="number" value="<?=$number?>">
	        </div>
